    ...
    <body>
        <div class="container">
           <?php
            ...
            ?>
            <h1>Adicionar Platos</h1>
            <hr>
            <div class="col-sm-6">
                <form id="frm1" method="post" action="agregarbd.php" class="form form-horizontal">
            		<label>Nombre</label>
                            <input type="text" id="txtced" name="txtced" required min="1" class="form-control">
            		<label>Valor</label>
            		<input type="number" id="txtnom" name="txtnom" maxlength="30" required class="form-control">
