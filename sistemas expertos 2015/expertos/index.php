	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">	
				...
				<a class="quick-button metro yellow span2" href="crearPerfil.php">
					<i class="icon-group"></i>
					<p>Crear Perfil</p>
					<span class="badge"></span>
				</a>
				<a class="quick-button metro red span2" href="ingresarAspirante.php">
					<i class="icon-user"></i>
					<p>Ingresar Aspirante</p>
					<span class="badge"></span>
				</a>
				<a class="quick-button metro blue span2" href="visualizarAspirantes.php">
