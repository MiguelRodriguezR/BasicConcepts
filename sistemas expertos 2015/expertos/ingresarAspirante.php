            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>Ingresar Aspirante</h2>
                        <div class="box-icon">
                        ...
                        <form class="form-horizontal" id="formulario">
                            <fieldset>
                             <div class="control-group">
                                ...
                                <div class="controls">
                                  <input class="input-xlarge " id="focusedInput" type="number" name="id" value="" required>
                                </div>
                              </div>
                              <div class="control-group">
                                <label class="control-label" for="focusedInput">Nombre</label>
                                <div class="controls">
                                  <input class="input-xlarge " id="focusedInput" type="text" name="nombre" value="" required>
                                </div>
                              </div>
                              <div class="control-group">
                                <label class="control-label" for="focusedInput">Apellido</label>
                                <div class="controls">
                                  <input class="input-xlarge " id="focusedInput" type="text" name="apellido" value="" required>
                                </div>
                              </div>
                              <div class="control-group">
